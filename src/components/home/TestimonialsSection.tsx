...
const TestimonialsSection = () => {
  ...
  return (
    <section id="testimonials" className="py-24 bg-luxury-50">
        ...
        <div className="relative max-w-4xl mx-auto">
            ...
            >
              {testimonials.map((testimonial, index) => (
                <div key={index} className="w-full flex-shrink-0 px-4">
                  <motion.div 
                    className="bg-white rounded-2xl shadow-lg p-8 relative border border-luxury-200"
                  ...
                  >
                    <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-luxury-800 text-lg mb-4 italic">
                          "{testimonial.text}"
                        </p>
                        <div>
          ...
          <div className="flex justify-center mt-8 space-x-2">
            <button 
              ...
              className="w-12 h-12 rounded-full bg-luxury-100 hover:bg-luxury-200 flex items-center justify-center transition-colors"
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all ${
                  activeIndex === index ? "bg-gold-400 w-6" : "bg-luxury-300"
                }`}
